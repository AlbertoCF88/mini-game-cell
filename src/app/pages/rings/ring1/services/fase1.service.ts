...
export class Fase1Service {
  ...
  base: boolean = true; //para los dos
  ...
  // barraCEll() {
  //   //vida en la vista
  //   this.vidaBarraCell = (this.vidaCell * 1) / 200;
  // }
  // barraGohan() {
  //   //vida en la vista
  //   this.vidaBarraGohan = (this.vidaGohan * 1) / 100;
  // }
  // choqueKames() {
  ...
  //         //daño directo
  //         this.vidaCell = this.vidaCell - 10;
  //         this.barraCEll();
  //         this.contadorGolpeBoton = this.contadorGolpeBoton + 1;
  //         this.rayaGohan = true;
  ...
  //   this.pulsar = false;
  //   /**Gohan */
  //   this.gohanBase = false;
  //   this.golpeGohan = false;
  //   this.rayaGohan = false;
  //   this.rayaGohan = false;
  //   this.defensaGohan = false;
  //   this.contraGohan = false;
  //   this.cargaGohan = false;
  //   this.kameGohan = false;
  //   this.heridaGohan = false;
  //   this.cansadoGohan = false;
  //   this.heridaKame = false;
  //   this.ganaGohan = false;
  //   /**Cell */
  //   this.baseCell = false;
